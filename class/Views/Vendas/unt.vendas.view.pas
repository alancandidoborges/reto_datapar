...
begin
  beep;
  confExcl:= Application.MessageBox('¿Quieres eliminar?','Atenção',MB_YESNO + MB_DEFBUTTON1 + MB_ICONINFORMATION);
  if confExcl = IDYES then
  begin
    FPedidoService.Delete(FDMemPrincipal.FieldByName('ID').AsInteger);
    CargaDatos();
  end;
end;
